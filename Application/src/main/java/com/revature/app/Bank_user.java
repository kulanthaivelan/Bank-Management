...
public class Bank_user {
	...
	public void CheckBalance() throws ClassNotFoundException {

		Account_Balance.getBalance(accid);
	}

	public void Deposit(int ACCOUNT_ID) throws SQLException, IOException, ClassNotFoundException {
		...
		Account_Balance.DepositBalance(deposit, ACCOUNT_ID);

	}

	public void Withdraw(int ACCOUNT_ID) throws SQLException, IOException, ClassNotFoundException {
		...
		Account_Balance.withdrawBalance(withdrawal, ACCOUNT_ID);
